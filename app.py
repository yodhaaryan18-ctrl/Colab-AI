...
# 1. Connect to the AI Brains (SECURED VIA SECRETS)
# Make sure to add these to the "Secrets" tab in Streamlit Advanced Settings!
...
with st.sidebar:
    ...
    # Note: st.audio_input is a built-in Streamlit feature
...
if final_input:
    ...
    if any(word in final_input.lower() for word in ["draw", "image", "picture", "paint"]):
        with st.chat_message("assistant", avatar="🎨"):
            ...
            st.image(url, caption="Generated by AI")
    ...
    # --- MASTER BRAIN RESPONSE ---
        ...
        with st.chat_message("assistant", avatar="✨"):
            with st.spinner("Thinking..."):
                ...
                # Gemini Analysis (Vision + Content)
                if img:
                ...
                # Final polish via Llama 3
                final_res = groq_client.chat.completions.create(
                    messages=[{"role": "system", "content": "You are a helpful assistant. Combine all context into a clear response."}, 
